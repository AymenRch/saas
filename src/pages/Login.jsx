        ...
        <div style={{
            ...
            <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 flex items-center justify-center p-4">
                <div className="w-full max-w-lg mx-auto">
                    ...
                    {/* Form */}
                    <div className="bg-white/10 text-start backdrop-blur-md border border-white/20 rounded-2xl p-8 shadow-2xl">
                        <form onSubmit={handleSubmit} className="space-y-6">
                            ...
                            <div className="flex items-center justify-between">
                                ...
                                <span className="text-purple-400 hover:text-purple-300 text-sm cursor-pointer transition-colors">
                                    Forgot password?
                                </span>
                            </div>
                            ...
                            <div className="grid grid-cols-2 gap-3">
                                <button
                                    type="button"
                                    className="flex items-center justify-center px-4 py-3 border border-white/20 bg-black rounded-lg text-white hover:bg-white/10 transition-all duration-200"
                                >
